...
# =============================
allowed_emails = [
    "yas1979.moa1949@gmail.com",
    "Mohamed.ashour88@yahoo.com",
    "hisham.hassan@live.com",
    "amoharram@gmail.com",
    "sayedgamal0402@gmail.com"
]
...
if user_email not in allowed_emails or user_password != password:
    st.warning("❌ البريد أو كلمة المرور غير صحيحة")
    st.stop()  # يوقف عرض باقي الداشبورد
...
creds = ServiceAccountCredentials.from_json_keyfile_name(
    "zinc-arc-377113-412e938f0d19.json",  # اسم الملف الجديد
    scope
)
